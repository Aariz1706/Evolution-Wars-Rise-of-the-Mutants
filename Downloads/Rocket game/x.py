# # # --- All your import and setup code remains unchanged ---
# # import pygame
# # import random
# # import os
# # import sys
...
# # # Your full constants setup (FPS, scores, assets, etc.) remains the same
# # FPS = 15
# # lives = 3
# # speed_bullet = -10
# # speed_rocket = 20
...
# # score = 0
# # bullets, rocks, enemy_bullets, bonuses, message = [], [], [], [], []
# # power_up = False
# # power_time = 0
# # bullet_cooldown = 250
# # shot_time = 0
...
# # # --- Load Assets (Images) as in your original code ---
# # # Assume all your asset loading (rocket_img, enemy_img, etc.) remains unchanged

# # # --- BossEnemy class and functions (boss_showing, level_bosses) remain unchanged ---
# # # Fix small bug:
...
# # # --- Pause Menu, Level Display, Add Message (unchanged) ---
# # def pause_menu():
# #     while True:
# #         screen.fill((0, 0, 0))
...
# #     while True:
# #         screen.fill((0, 0, 0))
# #         title_text = font_menu.render("Select Game Mode", True, (255, 255, 255))
# #         screen.blit(title_text, (width // 2 - title_text.get_width() // 2, 50))

# #         modes = [("Classic", "Normal"), ("Challenge", "Challenge"), ("Survival", "Survival")]
# #         buttons = []

# #         for index, (label, value) in enumerate(modes):
# #             rect = pygame.Rect(width // 2 - 100, 150 + index * 100, 200, 60)
# #             pygame.draw.rect(screen, (70, 130, 180), rect, border_radius=10)
# #             text = font_menu.render(label, True, (255, 255, 255))
...
# # # --- Game Mode Logic Functions: Normal, Challenge, Survival ---
# # def run_normal_mode():
# #     # Normal Mode: just spawn enemies
# #     pass

# # def run_challenge_mode():
# #     global start_time_level
# #     time_limit = 60000
# #     elapsed = pygame.time.get_ticks() - start_time_level
# #     remaining = max(0, (time_limit - elapsed) // 1000)
# #     timer_text = font_over.render(f"Time Left: {remaining}s", True, (255, 0, 0))
...
# #     pass  # Add increasing spawn rate logic here if needed
...
# #     # Your main game rendering and updating logic goes here
# #     pygame.display.update()
...
# # Load images
# background_img = pygame.image.load("background.jpg").convert()   # <-- Make sure this file exists
# rocket_img = pygame.image.load("rocket_image.png").convert_alpha()
# enemy_img = pygame.image.load("enemy_image.png").convert_alpha()
# bullet_img = pygame.image.load("bullet_image.png").convert_alpha()
# boss_img = pygame.image.load("boss_enemy.png").convert_alpha()
...
# # Spawn initial boss (only from level 2, but here for example)
# boss = BossEnemy()
...
#     # Draw everything
#     screen.blit(background_img, (0, 0))  # <-- THIS WAS THE ERROR before (now fixed)
